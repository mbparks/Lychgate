/* LYCHGATE vendored QR encoder :: v5.3.0
   QRCode for JavaScript, copyright 2009 Kazuhiko Arase.
   Vendored from qrcode-terminal's QRCode implementation. Original QRCode code is MIT licensed.
   This local copy is included only to render Passage Stone QR images without a network dependency.
*/
(function(){'use strict';
var modules={};
...
var cache={}; function req(name){if(cache[name])return cache[name].exports;if(!modules[name])throw new Error('Missing QR module '+name);var m={exports:{}};cache[name]=m;modules[name](m,m.exports,req);return m.exports;}
window.LG_QR={QRCode:req('index'),ErrorCorrectLevel:req('QRErrorCorrectLevel')};
}());
